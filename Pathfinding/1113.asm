...
Wait:
	...
	;Setup sonar alarm register ditsance to 2 feet
	LOAD Ft2
	OUT SONALARM
...
RRStop:
	LOADI 0
	STORE Dvel
	JUMP RRStop ;Temporary stop, will run circling function here
...
LLStop:
	LOADI 0
	STORE Dvel
	JUMP LLStop ;Temporary stop, will run circling function here
