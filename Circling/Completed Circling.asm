...
ReadY1For0:     
	CALL FULLSUBYPOS
	JUMP Continue1 ; to avoid executing next line 
ReadY1For5:
    CALL FULLSUBYNEG
...
ReadY2For0:
	CALL FULLSUBYNEG
	JUMP Continue2 ; to avoid executing next line
...
LoopFinal:
	...
	; Stop bot at the initial position after full square circle
	LOADI 0
	STORE Dvel
...
; Added by Farzam
; FOR LOR:
; 90  corresponds to sensor 0
; -90 corresponds to sensor 5
LOR:             DW  0
YPOSInitial:     DW  0
XPOSInitial: 	 DW  0
SENRadius:	 	 DW  0
